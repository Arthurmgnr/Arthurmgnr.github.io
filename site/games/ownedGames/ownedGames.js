...
// Filter Editeur
const games_low_editeur = ["Asmodée", "Blackrock Games", "Blue Orange", "Bombyx", "Cocktail Games", "Days of Wonder", "Don't Panic Games", "Dujardin",
    "Flip Flap Éditions", "Gamewright", "Gigamic", "Grandpa Beck's Games", "Hasbro", "Helvetiq", "Hurrican", "Iello", "Libellud",
    "Lumberjacks Studio", "Magilano", "Mixlore", "Oya", "Ravensburger", "Repos Production", "Schmidt Spiele GmbH", "Scorpion Masqué",
    "Smart Games", "Space Cowboys", "Studio H", "Z-Man Games"];
...
const games_low_categorie = ["Alignement", "Ambiance", "Association d'idées", "Aventure", "Bluff", "Cartes", "Casse-tête", "Chronologie",
    "Civilisation", "Code", "Combinaison", "Communication", "Connaissance", "Construction", "Coopératif", "Crimes",
    "Culture générale", "Dextérité", "Draw & Write", "Déduction", "Dés", "Développement", "Educatif", "Enchères",
    "Enigme", "Enquête", "Escape Game", "Exploration", "Extension", "Familial", "Gestion de ressources",
    "Interprétation d'images", "Jeu de mots", "Logique", "Mathématiques", "Missions", "Musique", "Mémoire", "Objectifs",
    "Observation", "Optimisation", "Pari", "Planification", "Plateau", "Plis", "Prise de risque", "Roll & Write", "Rôles",
...
async function loadGames() {
    try {
        const FILE_PATH = "/site/resources/data/games/owned_games_low.json";
